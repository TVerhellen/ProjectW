...
{
    internal static class ShapeWeed
    {
        ...
        public static Rectangle DrawFlowerPotWeb(int width, int height, Cultivator c, double left, double top)
        {
            Rectangle newRectangle = new Rectangle();
        ...
        public static Polygon DrawLampWeb(double left, double top, Cultivator c)
        {
            Polygon newLamp = new Polygon();
            PointCollection myPointCollection = new PointCollection();
